            ...
            <div class="px-4 px-lg-0">
                ...
                <div class="pb-5">
                    <div class="container">
                        ...
                        <div class="row py-5 p-4 bg-white rounded shadow-sm justify-content-end">
                            <div class="col-lg-6">
                                ...
                                <div class="p-4">
                                    ...
                                    </ul><a href="CheckOut.jsp?total=${total}" class="btn btn-dark rounded-pill py-2 btn-block">Mua hàng</a>
                                </div>
                            </div>
                        </div>
